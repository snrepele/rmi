...
public class Personas implements Serializable {
    ...
    public Personas(Integer cedula, String nombre, String apellido, String email) {
        this.cedula = cedula;
        this.nombre = nombre;
    ...
    public String toString() {
        return "servidorEntidades.Personas[ cedula=" + cedula + "Nombre: "+ nombre+"Apellido: "+apellido+"Email: "+email+" ]";
    }

    void getCedula(int i) {
